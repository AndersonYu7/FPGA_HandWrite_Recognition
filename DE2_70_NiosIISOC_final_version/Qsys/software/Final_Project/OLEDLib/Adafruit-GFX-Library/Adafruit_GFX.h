...
extern void Adafruit_GFX_init(tAdafruit_GFX *psInst, int16_t w, int16_t h, int16_t r, uint32_t  *buff); // Constructor
...
extern void fillRect(tAdafruit_GFX *psInst, int16_t x, int16_t y, int16_t w,
		int16_t h, uint32_t color);
extern void fillScreen(tAdafruit_GFX *psInst, uint32_t color);
...
extern void fillCircleHelper(tAdafruit_GFX *psInst, int16_t x0, int16_t y0,
		int16_t r, uint8_t cornername, int16_t delta, uint32_t color);
...
extern void drawRoundRect(tAdafruit_GFX *psInst, int16_t x0, int16_t y0,
		int16_t w, int16_t h, int16_t radius, uint32_t color);
...
//extern void setTextColor(tAdafruit_GFX *psInst, uint32_t c);
extern void setTextColor(tAdafruit_GFX *psInst,uint32_t c, uint32_t bg);
...
void Print(tAdafruit_GFX *psInst, unsigned char *str);
